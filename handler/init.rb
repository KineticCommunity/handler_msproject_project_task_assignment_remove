...
class MsprojectProjectTaskAssignmentRemoveV1
  ...
  def execute()
    ...
    # Check Out
    ############################################################################
    proj_resource["/_api/ProjectServer/Projects('#{project_id}')/Draft/checkIn()"].post ""
    proj_resource["/_api/ProjectServer/Projects('#{project_id}')/checkOut()"].post ""
    ...
    ############################################################################
    sleep(5)
    proj_resource["/_api/ProjectServer/Projects('#{project_id}')/Draft/publish(true)"].post ""
    sleep(5)
    proj_resource["/_api/ProjectServer/Projects('#{project_id}')/Draft/checkIn()"].post ""
